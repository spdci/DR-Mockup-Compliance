...
Given(/^SP has previously sent a search request to DR$/, function () {
  speconSearch = spec(); // Initialize the specSearch object
});

When(/^DR completes processing and calls SP on-search callback$/, async function () {
  try {
...
Then(/^SP should receive the on-search response from DR$/, async function () {
