@method=POST @endpoint=dr/unsubscribe
Feature: Unsubscribe from DR based on specific criteria

This API is to be exposed by the DR.
It will be called by the SP systems or other registeries .

    @smoke
    Scenario: Successfully unsubscribe from DR to be processed smoke type test
        Given System wanna unsubscribe from DR
